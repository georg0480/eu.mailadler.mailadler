...
do 
    ...
    rm -f localization/$lang/branding/*
      ...
      sed -i -e 's/Language pack for Thunderbird/Language pack for mailadler/' manifest.json

    echo "   * copying mailadler branding from en-US"
    branding_source="../../comm/mail/branding/mailadler/locales/en-US"
    ...
    then
      ...
      zip -qr "../langpack-$lang@mailadler.eu.xpi" manifest.json chrome localization
